#!/usr/bin/python -i
############################################################################
#                   sigGen -> SinkV49 (no BULKIO connect) SourceV49 -> plot 
#                          |
#                          -> plot
# Note: data is corrupted on second plot
#############################################################################
...
v49_out.advanced_configuration.force_transmit=True
...
v49_in.attachment_override.ip_address="127.0.0.1"
